...
func (controller *TareaController) TareaDetalleObtener(res http.ResponseWriter, req *http.Request) {
		...
		case "POST":
			{
				...
				if err == nil {
					...
					if err == nil {
						...
						future := async.Exec(func() interface{} {
							return infrastructure.TareaDetalleObtenerGetAsync(controller.DB, modelo)
						})
