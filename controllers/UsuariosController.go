...
func (controller *UsuarioController) UsuarioCalculatorInformacionObtener(res http.ResponseWriter, req *http.Request) {
	...
	if token == controller.SECRET_TOKEN {
		...
		case "POST":
			{
				//Actualizar aviso:
				var modelo *models.UsuarioCalculatorInformacionObtenerInputModel
				...
				if err == nil {
					...
					if err == nil {
						...
						future := async.Exec(func() interface{} {
							return infrastructure.UsuarioCalculatorInformacionObtenerGetAsync(controller.DB, modelo)
						})
