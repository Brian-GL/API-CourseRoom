...
func (controller *CatalogoController) EstatusTareaPendiente(res http.ResponseWriter, req *http.Request) {
...
func (controller *CatalogoController) CursoEstatus(res http.ResponseWriter, req *http.Request) {
...
func (controller *CatalogoController) Localidades(res http.ResponseWriter, req *http.Request) {
...
func (controller *CatalogoController) PreguntaRespuesta(res http.ResponseWriter, req *http.Request) {
...
func (controller *CatalogoController) PreguntasCuestionario(res http.ResponseWriter, req *http.Request) {
...
func (controller *CatalogoController) TiposUsuario(res http.ResponseWriter, req *http.Request) {
...
func (controller *CatalogoController) Tematicas(res http.ResponseWriter, req *http.Request) {
...
func (controller *CatalogoController) TiposArchivoObtener(res http.ResponseWriter, req *http.Request) {
		...
		case "POST":
			{
				...
				var modelo *models.TiposArchivoObtenerInputModel
